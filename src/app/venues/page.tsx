    ...
    <main className="min-h-screen bg-[#f5f3ef]">
      ...
      <section className="relative h-[380px] md:h-[420px] flex items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-20 max-w-3xl mx-auto px-4">
          <h1 className="text-2xl md:text-4xl font-serif font-bold text-white mb-4 mt-16">VENUES</h1>
          <p className="text-base md:text-md text-white/90 max-w-2xl mx-auto">
          Explore serene and meaningful venues designed to honor your loved one's memory with grace, beauty, and personal significance.
          </p>
        </div>
      </section>
      {/* Search Bar */}
      <section className="relative py-8 px-4 md:px-0" style={{background: 'url(/images/backdrop/floral.png) right top/cover no-repeat, #f5f3ef'}}>
        <div className="max-w-4xl mx-auto mb-8">
          <form className="flex flex-col sm:flex-row items-center gap-4">
            <div className="flex items-center bg-white rounded-lg px-4 py-3 w-full border border-[#d6c7a7] shadow">
              <svg className="w-5 h-5 text-[#a89578] mr-2" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
              <input
                type="text"
