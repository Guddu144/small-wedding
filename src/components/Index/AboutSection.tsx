    ...
    <section className="py-20 bg-white overflow-x-hidden">
      <div className="max-w-5xl mx-auto text-center px-4 md:px-24">
        ...
        <button
          ...
          tabIndex={0}
          aria-label="Learn more about Celebration of Life Concierge"
        >
          LEARN MORE
        </button>
      </div>
