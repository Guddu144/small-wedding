  ...
  return (
    <section className="py-20 bg-[#EAE4DA]">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-16">
        ...
        {venues.length > 0 ? (
             venues.map((venue) => (
               <div key={venue.name} className="border border-gray-200 rounded-lg overflow-hidden bg-white flex flex-col h-full">
                 ...
                 <div className="p-4 flex flex-col flex-grow">
                   <h3 className="text-[#0a3b5b] font-semibold text-xl mb-2">{venue.name}</h3>
